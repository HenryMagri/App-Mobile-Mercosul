...
export default function Documents() {
  ...
  const [routes] = React.useState([
    ...
    { key: 'second', title: 'CONDIÇÕES DO VEÍCULO' },
    { key: 'third', title: 'REGRAS' },
    { key: 'fourth', title: 'CONDUTOR RESIDENTE FORA DO BRASIL' },
    { key: 'fifth', title: 'DIREITO DE DEFESA E RECURSO' },
    { key: 'sixth', title: 'GLOSSÁRIO' },
    { key: 'seventh', title: 'BIBLIOGRAFIA' },
  ]);
