            ...
            <ScrollView
                ...
                <View>
                    ...
                    <View style={{ width: imageWidth, alignItems: 'center', marginTop: 0.05 * imageWidth }}>
                        ...
                        <Text style={{ textAlign: 'justify', width: 0.93 * imageWidth, marginTop: 0.04 * imageWidth, fontSize: selectSize, color: '#58585b', fontFamily: 'sans-serif', fontWeight: '600' }}>» Para saber si el vehículo tiene multas pendientes de pago, el propietario puede consultar, para infracciones en carreteras federales, el enlace de NADA CONSTA en el sitio web de la PRF o accesar el enlace “Consultar débitos” del sistema denominado AUTOPRF.</Text>
                        <ImageButton onPress={() => { Linking.openURL('https://pesquisa-auto.prf.gov.br/#/pesquisa/consultar-debitos') }} widthSize={selectSize * imageWidth * 0.023} heightSize={selectSize * imageWidth * 0.0073} margintopSize={selectSize}/>
                        <Text style={{ textAlign: 'justify', width: 0.93 * imageWidth, marginTop: 0.04 * imageWidth, fontSize: selectSize, color: '#58585b', fontFamily: 'sans-serif', fontWeight: '600' }}>Así como, buscar los órganos estatales y municipales de tránsito para infracciones en otras vías públicas del país.</Text>
